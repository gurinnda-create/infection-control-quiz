...
export const MOCK_GIFTS: GiftItem[] = [
    // Under 10k (Target: 10s - Pop & Trendy)
    {
        id: "1",
        name: "instax mini 12 チェキ",
        price: 9800,
    ...
    // 10k - 100k (Target: 20s-30s - Stylish & Practical)
    {
        id: "4",
        name: "Aesop レスレクション ハンドバーム & ソープ",
        price: 15000,
    ...
    // Over 100k (Target: Wealthy - Luxury & Experience)
    {
        id: "7",
    ...
    {
        id: "9",
        name: "JTB Travel Gift Card 100,000yen",
        price: 100000,
